...
{
    public class GetAssembliesToShadeTests : TestBase
    {
        [Fact]
        public void Test1()
        {
            ...
            MockNuGetAssetFileLoader assetsFileLoader = new MockNuGetAssetFileLoader
            {
            ...
            {
                [packageNewtonsoftJson9] = new List<(string Path, string Subdirectory, AssemblyName Name)>
                {
                    (pathNewtonsoftJson9, null, assemblyNameNewtonsoftJson9)
                },
                [packageNewtonsoftJson12] = new List<(string Path, string Subdirectory, AssemblyName Name)>
                {
                    (pathNewtonsoftJson12, null, assemblyNameNewtonsoftJson12)
                }
            };
